  ...
  return (
    <>
      <button
        ...
        type="button"
        >Favoritos<span className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">{favMoviesUser.length} <span className="visually-hidden">Favoritas</span></span>
        </button>  
    </>
  )
}
